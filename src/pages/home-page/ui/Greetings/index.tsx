        ...
        <div className="mt-8 px-6 flex flex-col items-center md:flex-row bg-gray-100">
            <div className="w-3/4 md:w-96 lg:w-2/5 relative md:ml-auto max-[767px]:mx-auto md:mr-2">
                <Button
                    variant="default"
                    size="sm"
                    className="md:text-sm h-2 p-3 lg:h-10 absolute max-[600px]:-left-6 max-[600px]:top-0 left-2 top-2 md:-left-6 md:top-2 lg:top-0 lg:-left-4 xl:top-2 xl:left-8 border-0 bg-orange-600 font-sans font-bold"
                    onClick={() => {
