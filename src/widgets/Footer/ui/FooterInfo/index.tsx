...
export function FooterInfo({ additionalClass }: { additionalClass: string }) {
    ...
    return (
        ...
        >
            <Image
                ...
                height="0"
                sizes="100vw"
                className="w-24 h-28 float-left md:h-14 md:w-12 md:mr-6 md:mb-2 lg:h-36 lg:w-32 lg:mb-0 lg:mr-0"
                style={{
