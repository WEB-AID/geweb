...
export function MapBlock() {
    ...
    return (
        <div className="w-3/4 lg:w-3/5 mx-auto flex flex-col md:flex-row items-center justify-center my-10 lg:my-16 font-extrabold">
            <div className="md:w-1/3 flex flex-col h-32 min-[600px]:h-24 md:h-60">
                ...
                <Button
                    variant="default"
                    size="sm"
                    className="border-0 bg-orange-600 font-sans font-bold mt-1 text-sm"
                    onClick={handleDirectionsClick}
                >
                    {t('mapButton')}
                </Button>
            </div>
            <div className="max-[767px]:mt-6 md:ml-12 w-full md:w-96 lg:w-1/2 flex items-center justify-center">
                <iframe
                    ...
                    width="0"
                    height="0"
                    className="border-0 w-full h-60 2xl:h-80 shadow-outer-brown"
                    // allowfullscreen=""
                    loading="lazy"
